...
{-selectUserPlansSince :: PersistQuery m => UserId -> UTCTime -> [SelectOpt Plan] -> SqlPersist m [Entity Plan]-}
...
{-createPlan :: (MonadIO m, PersistQuery m) => UserId -> NewPlan -> SqlPersist m (Entity Plan)-}
